    ...
    >
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="w-10 h-10 bg-linear-to-tr from-(--secondary) to-teal-400 rounded-full flex items-center justify-center text-white shadow-sm ring-2 ring-white group-hover:ring-(--secondary)/20 transition-all">
