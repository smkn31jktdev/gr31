...
// Kehadiran mocks base method.
func (m *MockDatabasePort) Kehadiran() outbound_port.KehadiranDatabasePort {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Kehadiran")
	ret0, _ := ret[0].(outbound_port.KehadiranDatabasePort)
	return ret0
}

// Kehadiran indicates an expected call of Kehadiran.
func (mr *MockDatabasePortMockRecorder) Kehadiran() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Kehadiran", reflect.TypeOf((*MockDatabasePort)(nil).Kehadiran))
}

// Sekolah mocks base method.
func (m *MockDatabasePort) Sekolah() outbound_port.SekolahDatabasePort {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Sekolah")
	ret0, _ := ret[0].(outbound_port.SekolahDatabasePort)
	return ret0
}
